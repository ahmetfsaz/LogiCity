...
class CityEnv(City):
    # [MODIFIED] Added config parameter to pass GNA and sub-rule analysis settings to parent City class
    def __init__(self, grid_size, local_planner, logic_engine_file, rl_agent, use_multi=False, config=None):
        super().__init__(grid_size, local_planner, logic_engine_file, use_multi=use_multi, config=config)
